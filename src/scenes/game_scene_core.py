...
class GameScene(Scene):
	...
	def __init__(self, screen: pygame.Surface, config: ConfigManager, game_state, save_manager):
		...
		self.logger.info('[GameScene] Submódulos integrados: waves, powerups, collisions, render')
	...
	def update(self):
		...
		if (current_time - self.powerup_spawn_timer > self.powerup_spawn_delay and random.random() < self.powerup_spawn_chance):
