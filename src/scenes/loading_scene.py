...
class LoadingScene(Scene):
	...
	def _render_progress_bar(self):
		...
		progress_text = font.render(f"{self.loading_progress:.1%}", True, (255, 255, 255))
		progress_rect = progress_text.get_rect(center=(self.screen.get_width() // 2, bar_y + bar_height + 20))
	...
	def _render_current_message(self):
		...
		if self.current_message_index < len(self.loading_messages):
			...
			message_rect = message_text.get_rect(center=(self.screen.get_width() // 2, 400))
