...
class CharacterAnimations:
        ...
        try:
            ...
            for path in possible_paths:
                try:
                    ...
                    if frames:
                        self.logger.debug(f"Frames cargados para {character_key} desde {path}")
                        break
                except:
                    continue
    ...
    def get_character_image_static(self, character_key: str) -> Optional[pygame.Surface]:
        """
        ...
        try:
            ...
            self.logger.error(f"Error obteniendo imagen estática de {character_key}: {e}")
            return self._create_character_placeholder(character_key)
