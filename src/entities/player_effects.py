...
class PlayerEffects:
    ...
    def __init__(self):
        ...
        self.active_effects: Dict[PowerupType, Tuple[float, float]] = {}  # {PowerupType: (end_time, value)}
    ...
    def get_effect_remaining_time(self, effect_type: PowerupType, current_time: float) -> float:
        """
