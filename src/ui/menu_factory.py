...
class MenuFactory:
    ...
    def __init__(self, screen: pygame.Surface, config: ConfigManager, 
                 save_manager: SaveManager, callbacks: MenuCallbacks):
        """
    ...
    def create_upgrade_menu(self) -> pygame_menu.Menu:
        ...
        menu.add.button("Mejorar Velocidad (1 punto)", self.callbacks.on_upgrade_speed, font_size=20)
        menu.add.vertical_margin(5)
        menu.add.button("Mejorar Daño (1 punto)", self.callbacks.on_upgrade_damage, font_size=20)
        menu.add.vertical_margin(5)
        menu.add.button("Mejorar Vida (1 punto)", self.callbacks.on_upgrade_health, font_size=20)
        menu.add.vertical_margin(5)
        menu.add.button("Mejorar Escudo (1 punto)", self.callbacks.on_upgrade_shield, font_size=20)
        menu.add.vertical_margin(20)
        
        menu.add.button("Continuar", self.callbacks.on_continue_after_upgrade, font_size=25)
    ...
    def create_character_select_menu(self) -> pygame_menu.Menu:
        ...
        menu.add.button("Guerrero", lambda: self.callbacks.on_select_character("guerrero"), font_size=20)
        menu.add.vertical_margin(5)
        menu.add.button("Arquera", lambda: self.callbacks.on_select_character("adventureguirl"), font_size=20)
        menu.add.vertical_margin(5)
        menu.add.button("Robot", lambda: self.callbacks.on_select_character("robot"), font_size=20)
        menu.add.vertical_margin(20)
    ...
    def create_options_menu(self) -> pygame_menu.Menu:
        ...
        menu.add.button("Configurar Controles", self.callbacks.on_configure_controls, font_size=18)
        menu.add.vertical_margin(10)
        menu.add.button("Guardar Opciones", self.callbacks.on_save_options, font_size=18)
        menu.add.vertical_margin(10)
    ...
    def create_inventory_menu(self) -> pygame_menu.Menu:
        ...
        menu.add.vertical_margin(5)
        menu.add.button("Equipar Accesorio", self.callbacks.on_equip_accessory, font_size=20)
        menu.add.vertical_margin(20)
