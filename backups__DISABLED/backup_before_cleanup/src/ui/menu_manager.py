...
class MenuManager:
    ...
    def _create_upgrade_menu(self):
        ...
        upgrade_points_label = menu.add.label(
            "0", font_size=25, font_color=(255, 255, 0)
        )
        menu.add.vertical_margin(20)

        # Mejoras disponibles
        menu.add.button(
            "Mejorar Velocidad (10 pts)", self._on_upgrade_speed, font_size=20
        )
        ...
        menu.add.button(
            "Mejorar Escudo (25 pts)", self._on_upgrade_shield, font_size=20
        )
        menu.add.vertical_margin(20)

        # Botones de navegación
        menu.add.button(
            "Continuar Juego", self._on_continue_after_upgrade, font_size=25
        )
        menu.add.vertical_margin(10)
    ...
    def _create_character_select_menu(self):
        ...
        menu.add.button(
            ...
            lambda: self._on_select_character("guerrero"),
            font_size=20,
        )
        menu.add.vertical_margin(10)
        ...
        menu.add.button(
            "Arquero - Rápido",
            lambda: self._on_select_character("arquero"),
            font_size=20,
        )
        menu.add.vertical_margin(10)

        menu.add.button(
            "Mago - Poderoso", lambda: self._on_select_character("mago"), font_size=20
        )
        menu.add.vertical_margin(20)
    ...
    def _create_options_menu(self):
        ...
        fullscreen_toggle = menu.add.toggle_switch(
            "Pantalla Completa: ", default=False, onchange=self._on_fullscreen_change
        )
        menu.add.vertical_margin(20)
        ...
        menu.add.button(
            "Configurar Controles", self._on_configure_controls, font_size=20
        )
        menu.add.vertical_margin(20)
    ...
    def _create_inventory_menu(self):
        ...
        menu.add.label(
            "No hay items en el inventario", font_size=20, font_color=(128, 128, 128)
        )
        menu.add.vertical_margin(20)
    ...
    def _create_save_menu(self):
        ...
        for i in range(3):
            ...
            menu.add.button(
                text, lambda x=i + 1: self._on_select_save_file(x), font_size=20
            )
            menu.add.vertical_margin(5)
    ...
    def update_upgrade_menu(self, upgrade_points: int):
        ...
        """
        if "upgrade" in self.menus and hasattr(
            self.menus["upgrade"], "upgrade_points_label"
        ):
