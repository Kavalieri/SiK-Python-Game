"""
Test Simple Character Navigation - Prueba Simplificada de Navegación
================================================================

Autor: SiK Team
Fecha: 2024
Descripción: Test simplificado para verificar el sistema de navegación con flechas.
"""
...
def test_simple_character_navigation():
    """Prueba simplificada del sistema de navegación de personajes."""
    ...
    character_data = {
        "guerrero": {
            "nombre": "Guerrero",
            "tipo": "Luchador",
            "stats": {"vida": 150, "velocidad": 100, "daño": 25, "escudo": 50, "rango_ataque": 80},
            "habilidades": ["Espada poderosa", "Escudo defensivo", "Carga frontal"]
        },
        "robot": {
            "nombre": "Robot",
            "tipo": "Tecnológico",
            "stats": {"vida": 120, "velocidad": 80, "daño": 30, "escudo": 30, "rango_ataque": 120},
            "habilidades": ["Disparo láser", "Escudo de energía", "Reparación automática"]
        },
        "adventureguirl": {
            "nombre": "Aventurera",
            "tipo": "Ágil",
            "stats": {"vida": 100, "velocidad": 120, "daño": 20, "escudo": 20, "rango_ataque": 100},
            "habilidades": ["Arco y flecha", "Movimiento rápido", "Sigilo"]
        }
    }
...
if __name__ == "__main__":
    test_simple_character_navigation() 