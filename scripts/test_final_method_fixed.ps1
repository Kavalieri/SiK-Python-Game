...
if ($afterCount -eq $beforeCount) {
    Write-Host "[RESULTADO] OK - No se abrieron nuevas instancias" -ForegroundColor Green
...
if ($afterCount -eq $beforeCount) {
    Write-Host "OK - Metodo --command funciona correctamente" -ForegroundColor Green
    Write-Host "OK - No se abren nuevas instancias de VS Code" -ForegroundColor Green
    Write-Host ""
    ...
    Write-Host "ERROR - El metodo aun abre nuevas instancias" -ForegroundColor Red
