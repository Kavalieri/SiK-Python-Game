...
class ProjectCleanerV2:
    ...
    def __init__(self):
        ...
        self.files_to_refactor = [
            ("src/scenes/character_select_scene.py", 530, "character_ui.py, character_data.py, character_animations.py"),
            ("src/scenes/game_scene.py", 509, "game_logic.py, game_rendering.py, game_entities.py"),
            ("src/entities/entity.py", 434, "entity_base.py, entity_physics.py, entity_renderer.py"),
            ("src/utils/save_manager.py", 426, "save_encryption.py, save_validation.py, save_serializer.py"),
            ("src/utils/desert_background.py", 408, "background_renderer.py, background_generator.py, background_tiles.py"),
            ("src/ui/hud.py", 399, "hud_renderer.py, hud_data.py, hud_widgets.py"),
            ("src/utils/asset_manager.py", 362, "asset_loader.py, asset_cache.py, asset_organizer.py"),
            ("src/entities/player.py", 341, "player_controller.py, player_animations.py, player_ui.py"),
            ("src/entities/enemy.py", 338, "enemy_ai.py, enemy_combat.py, enemy_spawner.py"),
            ("src/utils/world_generator.py", 315, "world_builder.py, world_tiles.py, world_objects.py"),
            ("src/ui/menu_callbacks.py", 306, "menu_navigation.py, menu_actions.py, menu_validation.py"),
            ("src/ui/menu_factory.py", 303, "menu_builder.py, menu_themes.py, menu_widgets.py"),
            ("src/utils/animation_manager.py", 288, "animation_loader.py, animation_player.py, animation_cache.py"),
            ("src/entities/powerup.py", 246, "powerup_types.py, powerup_effects.py, powerup_spawner.py"),
            ("src/entities/player_combat.py", 243, "combat_mechanics.py, combat_weapons.py, combat_effects.py"),
            ("src/scenes/loading_scene.py", 241, "loading_ui.py, loading_logic.py, loading_assets.py"),
            ("src/utils/input_manager.py", 240, "input_handler.py, input_mapping.py, input_validation.py"),
            ("src/entities/enemy_types.py", 232, "enemy_definitions.py, enemy_stats.py, enemy_abilities.py"),
            ("src/core/game_engine.py", 209, "engine_core.py, engine_loop.py, engine_events.py"),
            ("src/entities/tile.py", 207, "tile_types.py, tile_renderer.py, tile_collision.py"),
            ("src/entities/player_effects.py", 175, "effects_manager.py, effects_types.py, effects_ui.py"),
            ("src/ui/menu_manager.py", 164, "menu_controller.py, menu_state.py"),
            ("src/utils/config_manager.py", 164, "config_loader.py, config_validator.py, config_defaults.py"),
        ]
    ...
    def setup_logging(self):
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler(log_dir / f"cleanup_v2_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"),
