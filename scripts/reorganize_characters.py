...
def reorganize_characters():
    ...
    characters_used = ["guerrero", "adventureguirl", "robot", "zombiemale", "zombieguirl"]
    ...
    character_dirs = [d for d in assets_path.iterdir() if d.is_dir() and d.name not in ["used", "unused"]]
