...
def test_config_manager():
    ...
    try:
        ...
        return False
    except (AttributeError, FileNotFoundError) as config_err:
        print(f"❌ Error de configuración: {config_err}")
        return False
...
def test_character_data():
    ...
    except (ImportError, AttributeError, KeyError) as char_err:
        print(f"❌ Error en datos de personajes: {char_err}")
        return False
...
def test_database_system():
    ...
    try:
        ...
        return False
    except (AttributeError, FileNotFoundError) as db_err:
        print(f"❌ Error en sistema SQLite: {db_err}")
        return False
