...
def test_config_system():
    ...
    try:
        ...
        for char_key in characters:
            ...
            print(f"  {char_key}: {char_data.get('nombre', 'N/A')} - Vida: {stats.get('vida', 0)}")
        ...
        for enemy_type in enemies:
            ...
            print(f"  {enemy_type}: {enemy_data.get('nombre', 'N/A')} - Vida: {enemy_data.get('stats', {}).get('vida', 0)}")
        ...
        for powerup_type in powerups:
            ...
            print(f"  {powerup_type}: {powerup_data.get('nombre', 'N/A')} - Duración: {powerup_data.get('duración', 0)}s")
...
def main():
    ...
    # Resumen
    print("\n=== RESUMEN ===")
    print(f"Sistema de configuración: {'✅ EXITOSO' if config_success else '❌ FALLIDO'}")
    print(f"Módulo CharacterData: {'✅ EXITOSO' if character_success else '❌ FALLIDO'}")
